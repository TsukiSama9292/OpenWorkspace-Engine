...
- Part of per-instance `/30` isolation spec (`.scratch/docker-in-instance_2/spec.md`). Default base `10.200.0.0/16` was chosen against the live host ranges (docker0 `172.17.0.0/16`, LAN `10.122.78.0/24`, wireguard `10.0.255.0/24`, tailscale `100.64.0.0/10`).
