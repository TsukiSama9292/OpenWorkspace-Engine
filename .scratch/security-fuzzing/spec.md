...
- The actual registered endpoint count is **40**, not 57 (the "57" was a count of method keywords in `docs/api-reference.md`, which double-counts table cells). The green subset is 17.
