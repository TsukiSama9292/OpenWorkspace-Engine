...
### Admin protection: the admin account can no longer be deleted or demoted (`.scratch/admin-protection/`)
...
### Security fuzzing: utoipa OpenAPI spec + Schemathesis dual-pass (`.scratch/security-fuzzing/`)
